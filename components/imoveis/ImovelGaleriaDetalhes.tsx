...
export function ImovelGaleriaDetalhes({ fotos, titulo }: ImovelGaleriaDetalhesProps) {
  ...
  return (
    <>
      <div className="mx-auto mb-10 max-w-3xl">
        {/* Mobile: main photo + horizontal thumbnails */}
        ...
        {/* Desktop: shared 4:3 height — main left (2fr), thumbnails right (1fr) */}
        <div
